...
int main()
{
	...
	switch(player.setup_music_load())
	{
		case 0: mciSendString("open \"japan.mp3\" type mpegvideo alias mp3", NULL, 0, NULL); break;
		case 1: mciSendString("open \"nature.mp3\" type mpegvideo alias mp3", NULL, 0, NULL); break;
		case 2: mciSendString("open \"scifi.mp3\" type mpegvideo alias mp3", NULL, 0, NULL); break;
		case 3: mciSendString("open \"custom.mp3\" type mpegvideo alias mp3", NULL, 0, NULL); break;
	}
